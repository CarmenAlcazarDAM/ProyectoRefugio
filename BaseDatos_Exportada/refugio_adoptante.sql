...
CREATE TABLE `adoptante` (
  `dniAdoptante` char(9) NOT NULL,
  PRIMARY KEY (`dniAdoptante`),
  CONSTRAINT `adoptante_ibfk_1` FOREIGN KEY (`dniAdoptante`) REFERENCES `persona` (`dni`)
...
INSERT INTO `adoptante` VALUES ('11223344K'),('12345678Z'),('34567890V'),('55443322L'),('87654321A');
...
-- Dump completed on 2026-05-22 12:46:12
