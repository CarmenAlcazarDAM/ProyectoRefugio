...
CREATE TABLE `gato` (
  `idGato` int unsigned NOT NULL,
  `leucemiaFelina` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`idGato`),
  CONSTRAINT `gato_ibfk_1` FOREIGN KEY (`idGato`) REFERENCES `animal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `gato` VALUES (1,0),(2,0),(4,0),(19,0),(20,0),(21,1),(22,0),(23,0),(25,0);
