...
public class AyudaDAO {
    ...
    /**
     * Método que busca una única tarea por su clave primaria.
     *
    ...
    /**
     * Método que busca todas las tareas realizadas en una determinada ubicacion
     *
    ...
    /////////////////////// INSERT ///////////////////////
    /**
     * Método que inserta una ayuda en la base de datos
    ...
    /// //////////////////// DELETE ///////////////////////
    /**
     * Método que borra una ayuda de la base de datos
     * @param dniVoluntario --> dni del voluntario a buscar
     * @param idUbicacion --> ubicacion donde se realiza la accion
     * @param fecha --> fecha en la que se realiza una acción
    ...
    /**
     * Método que actualiza la ubicacion de una Ayuda
    ...
    /**
     * Método que actualiza la informacion de la tarea de una Ayuda
     * @param a --> Ayuda que vamos a actualizar pasada porparámetro
